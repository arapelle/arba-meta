...
{
    int option = 0;
    std::cout << tfunc(meta::default_v, meta::default_v) << " ; " << option << std::endl; // option == 0
    std::cout << tfunc(meta::default_v, option) << " ; " << option << std::endl;          // option == 1
    std::cout << tfunc(42, option) << " ; " << option << std::endl;                       // option == 2
