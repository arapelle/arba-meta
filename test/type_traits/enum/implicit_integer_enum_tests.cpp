...
class PrimaryColor : public meta::enumerator<int, PrimaryColors, meta::enum_conversion::implicit_conversion>
{
private:
    using base_ = meta::enumerator<int, PrimaryColors, meta::enum_conversion::implicit_conversion>;
...
TEST(implicit_integer_enum_tests, primary_colors__implicit_conversion__ok)
{
...
TEST(implicit_integer_enum_tests, colors__implicit_conversion__ok)
{
    static_assert(std::convertible_to<Color, Color::value_type>);
...
TEST(implicit_integer_enum_tests, colors__comparison_with_value_type__ok)
{
    static_assert(std::convertible_to<Color, Color::value_type>);
...
TEST(implicit_integer_enum_tests, shapes__index__ok)
{
...
TEST(implicit_integer_enum_tests, constexpr_shapes__index__ok)
{
