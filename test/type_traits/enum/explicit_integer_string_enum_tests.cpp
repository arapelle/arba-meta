...
{
public:
    static constexpr CustomColor black = make_enumerator(9, "black");
    static constexpr CustomColor white = make_enumerator(11, "white");
...
TEST(explicit_integer_string_enum_tests, primary_colors__static_assertions__valid)
{
    ...
    static_assert(!std::totally_ordered_with<PrimaryColor, Color>);
    static_assert(!std::totally_ordered_with<PrimaryColor, CustomColor>);
    static_assert(PrimaryColors::enumerator_index_offset() == 3);
    static_assert(PrimaryColors::enumerator_index_factor() == 2);
}

TEST(explicit_integer_string_enum_tests, primary_colors__construction__ok)
{
    PrimaryColor color;
...
TEST(explicit_integer_string_enum_tests, constexpr_primary_colors__construction__ok)
{
...
TEST(explicit_integer_string_enum_tests, primary_colors__value__ok)
{
...
TEST(explicit_integer_string_enum_tests, constexpr_primary_colors__value__ok)
{
...
TEST(explicit_integer_string_enum_tests, primary_colors__index__ok)
{
...
TEST(explicit_integer_string_enum_tests, constexpr_primary_colors__index__ok)
{
...
TEST(explicit_integer_string_enum_tests, primary_colors__name__ok)
{
...
#if __cpp_constexpr >= 202211L
TEST(explicit_integer_string_enum_tests, constexpr_primary_colors__name__ok)
{
...
TEST(explicit_integer_string_enum_tests, primary_colors__enumeration_size__ok)
{
    ASSERT_EQ(PrimaryColors::size(), 3);
    static_assert(PrimaryColors::size() == 3);
}

TEST(explicit_integer_string_enum_tests, primary_colors__all__ok)
{
    ASSERT_EQ(PrimaryColors::all(), PrimaryColors::enumerators);
    static_assert(PrimaryColors::all() == PrimaryColors::enumerators);
}

TEST(explicit_integer_string_enum_tests, primary_colors__explicit_conversion__ok)
{
...
TEST(explicit_integer_string_enum_tests, primary_colors__comparison_with_primary_color__ok)
{
    static_assert(!std::convertible_to<PrimaryColor, PrimaryColor::value_type>);
...
TEST(explicit_integer_string_enum_tests, primary_colors__hash__ok)
{
...
TEST(explicit_integer_string_enum_tests, primary_colors__format__ok)
{
...
TEST(explicit_integer_string_enum_tests, colors_enum__static_assertions__valid)
{
    ...
    static_assert(!std::totally_ordered_with<Color, CustomColor>);
...
TEST(explicit_integer_string_enum_tests, colors__construction__ok)
{
    Color color;
...
TEST(explicit_integer_string_enum_tests, constexpr_colors__construction__ok)
{
...
TEST(explicit_integer_string_enum_tests, colors__value__ok)
{
...
TEST(explicit_integer_string_enum_tests, constexpr_colors__value__ok)
{
...
TEST(explicit_integer_string_enum_tests, colors__name__ok)
{
...
#if __cpp_constexpr >= 202211L
TEST(explicit_integer_string_enum_tests, constexpr_colors__name__ok)
{
...
TEST(explicit_integer_string_enum_tests, colors__enumeration_size__ok)
{
    ASSERT_EQ(Colors::size(), 6);
    static_assert(Colors::size() == 6);
}

TEST(explicit_integer_string_enum_tests, colors__all__ok)
{
...
TEST(explicit_integer_string_enum_tests, colors__explicit_conversion__ok)
{
...
TEST(explicit_integer_string_enum_tests, colors__comparison_with_color__ok)
{
    static_assert(!std::convertible_to<Color, Color::value_type>);
    ...
    ASSERT_NE(Colors::green, Color(Colors::red));
    ASSERT_GT(Colors::green, Color(Colors::red));
}

TEST(explicit_integer_string_enum_tests, colors__hash__ok)
{
...
TEST(explicit_integer_string_enum_tests, colors__format__ok)
{
