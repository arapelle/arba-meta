...
class PrimaryColor : public meta::named_u8_enumerator64<PrimaryColors, meta::enum_conversion::implicit_conversion>
{
private:
    using base_ = meta::named_u8_enumerator64<PrimaryColors, meta::enum_conversion::implicit_conversion>;
...
TEST(implicit_integer_string_enum_tests, primary_colors__static_assertions__valid)
{
...
TEST(implicit_integer_string_enum_tests, primary_colors__construction__ok)
{
    PrimaryColor color;
...
TEST(implicit_integer_string_enum_tests, constexpr_primary_colors__construction__ok)
{
...
TEST(implicit_integer_string_enum_tests, primary_colors__value__ok)
{
...
TEST(implicit_integer_string_enum_tests, constexpr_primary_colors__value__ok)
{
...
TEST(implicit_integer_string_enum_tests, primary_colors__index__ok)
{
...
TEST(implicit_integer_string_enum_tests, constexpr_primary_colors__index__ok)
{
...
TEST(implicit_integer_string_enum_tests, primary_colors__name__ok)
{
...
#if __cpp_constexpr >= 202211L
TEST(implicit_integer_string_enum_tests, constexpr_primary_colors__name__ok)
{
...
TEST(implicit_integer_string_enum_tests, primary_colors__enumeration_size__ok)
{
    ASSERT_EQ(PrimaryColors::size(), 3);
    static_assert(PrimaryColors::size() == 3);
}

TEST(implicit_integer_string_enum_tests, primary_colors__all__ok)
{
    ASSERT_EQ(PrimaryColors::all(), PrimaryColors::enumerators);
    static_assert(PrimaryColors::all() == PrimaryColors::enumerators);
}

TEST(implicit_integer_string_enum_tests, primary_colors__implicit_conversion__ok)
{
...
TEST(implicit_integer_string_enum_tests, primary_colors__hash__ok)
{
...
TEST(implicit_integer_string_enum_tests, primary_colors__format__ok)
{
...
TEST(implicit_integer_string_enum_tests, colors_enum__static_assertions__valid)
{
...
TEST(implicit_integer_string_enum_tests, colors__construction__ok)
{
    Color color;
    color = Colors::orange;
...
TEST(implicit_integer_string_enum_tests, constexpr_colors__construction__ok)
{
...
TEST(implicit_integer_string_enum_tests, colors__value__ok)
{
...
TEST(implicit_integer_string_enum_tests, constexpr_colors__value__ok)
{
...
TEST(implicit_integer_string_enum_tests, colors__name__ok)
{
...
#if __cpp_constexpr >= 202211L
TEST(implicit_integer_string_enum_tests, constexpr_colors__name__ok)
{
...
TEST(implicit_integer_string_enum_tests, colors__enumeration_size__ok)
{
...
TEST(implicit_integer_string_enum_tests, colors__implicit_conversion__ok)
{
...
TEST(implicit_integer_string_enum_tests, colors__comparison_with_value_type__ok)
{
    static_assert(std::convertible_to<Color, Color::value_type>);
    ASSERT_EQ(Colors::purple, static_cast<Color::value_type>(9));
    ASSERT_NE(Colors::purple, static_cast<Color::value_type>(19));
    ASSERT_LT(Colors::purple, static_cast<Color::value_type>(10));
    ASSERT_LE(Colors::purple, static_cast<Color::value_type>(9));
    ASSERT_GT(Colors::purple, static_cast<Color::value_type>(0));
    ASSERT_GE(Colors::purple, static_cast<Color::value_type>(1));
}

TEST(implicit_integer_string_enum_tests, colors__hash__ok)
{
...
TEST(implicit_integer_string_enum_tests, colors__format__ok)
{
...
TEST(implicit_integer_string_enum_tests, shapes__index__ok)
{
...
TEST(implicit_integer_string_enum_tests, constexpr_shapes__index__ok)
{
