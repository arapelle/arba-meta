...
TEST(implicit_integer_string_enum_tests, primary_colors__explicit_conversion__ok)
{
...
TEST(implicit_integer_string_enum_tests, primary_colors__comparison_with_primary_color__ok)
{
    static_assert(std::convertible_to<PrimaryColor, PrimaryColor::value_type>);
...
TEST(implicit_integer_string_enum_tests, colors__explicit_conversion__ok)
{
...
TEST(implicit_integer_string_enum_tests, colors__comparison_with_color__ok)
{
    static_assert(std::convertible_to<Color, Color::value_type>);
