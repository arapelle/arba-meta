...
class ArbaMetaRecipe(ConanFile):
    project_namespace = "arba"
    project_base_name = "meta"
    ...
    url = "https://github.com/arapelle/arba-meta"
    homepage = "https://github.com/arapelle/arba-meta"
    topics = ("type-traits", "template", "policy")
    license = "MIT"
